...
abstract class RouteCompletionRepository {
  ...
  Future<Result<RouteCompletionModel>> createCompletion({required int routeId, required bool completed, String? memo});

  Future<Result<RouteCompletionModel>> updateCompletion({required int routeId, required bool completed, String? memo});
